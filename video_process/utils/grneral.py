...
def strip_optimizer(f='weights/best.pt', s=''):  # from reid_utils.general import *; strip_optimizer()
...
def coco_only_people(path='../coco/labels/train2017/'):  # from reid_utils.general import *; coco_only_people()
...
def crop_images_random(path='../images/', scale=0.50):  # from reid_utils.general import *; crop_images_random()
...
def coco_single_class_labels(path='../coco/labels/train2014/', label_class=43):
    # Makes single-class coco datasets. from reid_utils.general import *; coco_single_class_labels()
...
def kmean_anchors(path='./data/coco128.yaml', n=9, img_size=640, thr=4.0, gen=1000, verbose=True):
    """ Creates kmeans-evolved anchors from training dataset
        ...
        Usage:
            from reid_utils.general import *; _ = kmean_anchors()
    """
    thr = 1. / thr
...
def plot_wh_methods():  # from reid_utils.general import *; plot_wh_methods()
...
def plot_test_txt():  # from reid_utils.general import *; plot_test()
...
def plot_targets_txt():  # from reid_utils.general import *; plot_targets_txt()
...
def plot_study_txt(f='study.txt', x=None):  # from reid_utils.general import *; plot_study_txt()
...
def plot_evolution(yaml_file='data/hyp.finetune.yaml'):  # from reid_utils.general import *; plot_evolution()
...
def plot_results_overlay(start=0, stop=0):  # from reid_utils.general import *; plot_results_overlay()
...
def plot_results(start=0, stop=0, bucket='', id=(), labels=(),
                 save_dir=''):  # from reid_utils.general import *; plot_results()
