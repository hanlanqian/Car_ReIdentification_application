...
def strip_optimizer(f='weights/best.pt'):  # from reid_utils.reid_utils import *; strip_optimizer()
...
def create_pretrained(f='weights/best.pt', s='weights/pretrained.pt'):  # from reid_utils.reid_utils import *; create_pretrained()
...
def coco_only_people(path='../coco/labels/train2017/'):  # from reid_utils.reid_utils import *; coco_only_people()
...
def crop_images_random(path='../images/', scale=0.50):  # from reid_utils.reid_utils import *; crop_images_random()
...
def coco_single_class_labels(path='../coco/labels/train2014/', label_class=43):
    # Makes single-class coco datasets. from reid_utils.reid_utils import *; coco_single_class_labels()
...
def kmean_anchors(path='./data/coco128.yaml', n=9, img_size=640, thr=4.0, gen=1000, verbose=True):
    """ Creates kmeans-evolved anchors from training dataset
        ...
        Usage:
            from reid_utils.reid_utils import *; _ = kmean_anchors()
    """
    thr = 1. / thr
...
def change_cv2_draw(image, strs, local, sizes, colour):
    ...
    font = ImageFont.truetype("CASTELAR.TTF", 32, encoding="unic")
...
def plot_wh_methods():  # from reid_utils.reid_utils import *; plot_wh_methods()
...
def plot_test_txt():  # from reid_utils.reid_utils import *; plot_test()
...
def plot_targets_txt():  # from reid_utils.reid_utils import *; plot_targets_txt()
...
def plot_study_txt(f='study.txt', x=None):  # from reid_utils.reid_utils import *; plot_study_txt()
...
def plot_evolution_results(hyp):  # from reid_utils.reid_utils import *; plot_evolution_results(hyp)
...
def plot_results_overlay(start=0, stop=0):  # from reid_utils.reid_utils import *; plot_results_overlay()
...
def plot_results(start=0, stop=0, bucket='', id=(), labels=(),
                 save_dir=''):  # from reid_utils.reid_utils import *; plot_results()
